/* ============================================================
   ...
   Load after js/portfolio-data.js on every page.
   ============================================================ */

(function () {
  'use strict';

  var categories = (window.PHOTO_CATEGORIES || []).map(function (c) {
  ...
  /* ----------------------------------------------------------
     Which section is active on this page is declared on the
     <body> element:  data-page="home" | "portfolio" | "tools".
     Optional data-category="still life" highlights a category.
     ---------------------------------------------------------- */
  ...
  var html =
      ...
      '<div class="site-nav__links">' +
        ...
        '<div class="nav-drop">' +
          ...
          '<div class="nav-drop__panel nav-drop__panel--wide">' +
            ...
            '<div class="nav-drop__grid">' + categoryChips() + '</div>' +
    ...
    '<div class="mobile-panel" id="mobile-menu" aria-hidden="true">' +
      ...
      '<div class="mobile-acc__body">' + mobileLinks() + '</div>' +
